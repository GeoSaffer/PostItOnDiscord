...
namespace DiscordWebhook
{
    ...
    public class Webhook
    {
        ...
        {
            var testString = JsonConvert.SerializeObject(this);
            var content = new StringContent(testString, Encoding.UTF8, "application/json");
            
            var test = await _httpClient.PostAsync(_webhookUrl, content);
            return test;
        }
